...
def get_a_page_book(second_type_url):
    try:
        ...
        return
    # 循环获取图书
    if not CONN.get_collection('book2').find_one({'title': list(book_first_page_60_urls.items())[-1][0]}):  # 跳过已有的
